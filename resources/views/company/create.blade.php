    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card ">
                ...
                <form action="{{ route('company.store')}}" method="post" enctype="multipart/form-data" class="p-5">
                    @csrf                 
                    ...
                    <div class="mb-3">
                      ...
                      <input type="text" class="form-control" id="name" placeholder="Compnay Title" name="title" value="{{ old('title')}}">                      
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="url" class="form-control" id="website" placeholder="Compnay website" name="website" value="{{ old('website')}}">                      
                    </div>
